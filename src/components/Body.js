...
const Body = () => {
    ...
    const fetchData = async () => {
        try {
            const response = await fetch("https://cors.sh/https://www.swiggy.com/dapi/restaurants/list/v5?lat=28.7040592&lng=77.10249019999999&is-seo-homepage-enabled=true&page_type=DESKTOP_WEB_LISTING");
